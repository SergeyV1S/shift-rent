...
export const CarCard = (car: Car) => {
  ...
  return (
    <div className='hover:border-brand-primary transition-[transform, border-color] flex w-[300px] flex-col gap-6 rounded-lg border border-transparent p-4 duration-300 hover:z-10 hover:origin-bottom hover:scale-110 hover:rotate-1'>
      <img
